...
var ignoreSSLIssuesAgent = new https_1.default.Agent({ rejectUnauthorized: false });
// Check if we should send cross-domain credentials
var sendCrossDomainCredentials = !!(process.env.DEV
...
var sendRequest = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var numRetries, method, stringifiedParams, query, url, ignoreSSLIssues, httpsAgent, headers, data, response, err_1;
